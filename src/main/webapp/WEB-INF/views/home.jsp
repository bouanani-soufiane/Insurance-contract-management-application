...
<nav class="bg-white shadow dark:bg-gray-800">
    <div class="container px-6 py-4 mx-auto">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center text-gray-600 capitalize dark:text-gray-300">
                    <a href="#" class="mx-4 hover:text-gray-900 dark:hover:text-gray-200">features</a>
                    <a href="#" class="mx-4 hover:text-gray-900 dark:hover:text-gray-200">downloads</a>
                    <a href="#" class="mx-4 hover:text-gray-900 dark:hover:text-gray-200">docs</a>
                    <a href="#" class="mx-4 hover:text-gray-900 dark:hover:text-gray-200">support</a>
                    <a href="#" class="mx-4 hover:text-gray-900 dark:hover:text-gray-200">blog</a>
                    ...
                    <div class="relative mx-4">
                        ...
                        <input type="text"
                               class="w-56 py-1 pl-10 pr-4 text-gray-700 bg-white border-b border-gray-600 focus:outline-none focus:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:placeholder-gray-300 dark:focus:border-gray-300"
                               placeholder="Search">
                    </div>
                </div>
